"""Records of what each user retrieved, when, and whether the search saw everything.
...
def upgrade() -> None:
    ...
    op.create_index("ix_evidence_retrievals_owner_id", "evidence_retrievals", ["owner_id"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_evidence_retrievals_owner_id", table_name="evidence_retrievals")
